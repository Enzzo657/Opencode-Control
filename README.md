...
project root, Control показывает изображение прямо в сообщении. Карточка содержит
действия `Открыть` и `Скачать`, а также полный путь файла на диске. Поддерживаются PNG,
JPEG, GIF, WebP, AVIF и ICO размером до 50 MB. Remote images не загружаются автоматически.
