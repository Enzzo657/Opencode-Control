...
при необходимости сначала переключая активный проект. Недоступный OpenCode server не
ломает global search: Control показывает сохранённые совпадения и отмечает partial result.
