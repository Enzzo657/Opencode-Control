...
клавиатуры. На карточке и во viewer доступно скачивание. Поддерживаются PNG, JPEG, GIF,
WebP, AVIF и ICO размером до 50 MB. Remote images не загружаются автоматически.
