...
- Большинство frontend-экранов всё ещё находится в `App.tsx`; Dashboard и Instructions
  уже вынесены, остальные экраны будут переноситься отдельными небольшими изменениями.
